...
function loadWriteTAG() {
    ...
    var span = document.createElement("SPAN")
    span.innerHTML =
        `<img class="innerimg TAG" alt="writeTAG_RENAL" onmouseover = "onElementOver(this);" onmouseleave = "onElementLeave();" id="writeTAG_RENAL" src="../image/icon/lite/tag_renal.png" width="50" height="50">`;
    ...
    var span = document.createElement("SPAN")
    span.innerHTML =
        `<img class="img TAG" alt="saveTAG" id="saveTAG_RENAL" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/tag_renal.png" width="50" height="50" style="display:none;" >`;
    addIconSpan(span);
